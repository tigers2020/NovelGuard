...
- Edit only this target card: .devtool/features/spec-review/pr-52-2026-06-04-spec-draft.md
- Read source Inbox: .devtool/features/pr-52-legacy-novelguard-migration-2026-06-04-inbox.md
- Record approval on the spec card only when no blocking gaps remain.

Inputs:
- work_id: pr-52-2026-06-04
