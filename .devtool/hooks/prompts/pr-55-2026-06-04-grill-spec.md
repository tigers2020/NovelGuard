...
- Edit only this target card: .devtool/features/pr-55-2026-06-04-spec-draft.md
- Read source Inbox: .devtool/features/pr-55-windows-installer-v1-unsigned-2026-06-04-inbox.md
- Record approval on the spec card only when no blocking gaps remain.

Inputs:
- work_id: pr-55-2026-06-04
