...
class BlockingService:
    ...
    def create_blocking_groups(
        ...
        primary_groups: dict[tuple[str, str], list[tuple[FileEntry, FilenameParseResult]]] = (
            defaultdict(list)
        )
        ...
        for (extension, series_title_norm), file_data in primary_groups.items():
            ...
            secondary_groups: dict[Optional[int], list[tuple[FileEntry, FilenameParseResult]]] = (
                defaultdict(list)
            )
            ...
            for range_start, secondary_file_data in secondary_groups.items():
                ...
                tertiary_groups: dict[
                    Optional[str], list[tuple[FileEntry, FilenameParseResult]]
                ] = defaultdict(list)
