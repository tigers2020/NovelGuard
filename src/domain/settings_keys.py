...
SETTINGS_KEY_LIBRARY_LAST_FOLDER_PATH = "library.lastFolderPath"
...
ALL_SETTING_KEYS: frozenset[str] = (
    frozenset({SETTINGS_KEY_INCLUDE_RELATION, SETTINGS_KEY_LIBRARY_LAST_FOLDER_PATH})
    | ALL_SCAN_SETTING_KEYS
)

STRING_SETTING_KEYS: frozenset[str] = frozenset(
    {
        SETTINGS_KEY_SCAN_EXTENSION_FILTER,
