...
_BLOCKER_MESSAGES: dict[str, str] = {
    ...
    "QUALITY_ERROR_ISSUES": "인코딩 또는 무결성 품질 오류가 남아 있습니다.",
}
...
def compute_finalize_blockers(
    *,
    ...
    quality_errors = encoding_issue_count + integrity_issue_count
    if quality_errors > 0:
        blockers.append(_blocker("QUALITY_ERROR_ISSUES", count=quality_errors))
    return blockers
