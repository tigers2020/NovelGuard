...
class ScanViewModel(BaseViewModel):
    ...
    def start_scan(self, folder: Path, extensions: str = "", **options) -> None:
        ...
        ext_list: Optional[list[str]] = (
            parsed_extensions if parsed_extensions else DEFAULT_TEXT_EXTENSIONS
        )
        ...
        debug_step(self._log_sink, "scan_view_model_scan_started", {"job_id": self._current_job_id})
    ...
    def _on_job_failed(self, job_id: int, error: str) -> None:
        ...
        Args:
            ...
            error: 에러 메시지.
        """
        debug_step(self._log_sink, "scan_view_model_job_failed", {"job_id": job_id, "error": error})
    ...
    def _on_job_cancelled(self, job_id: int) -> None:
        ...
        Args:
            job_id: Job ID.
        """
        debug_step(self._log_sink, "scan_view_model_job_cancelled", {"job_id": job_id})
