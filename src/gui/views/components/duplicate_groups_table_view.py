...
class DuplicateGroupsTableView(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 그룹 ID
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 파일 수
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.Stretch)  # 추천 Keeper
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 신뢰도
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.Stretch)  # 작품명/제목
