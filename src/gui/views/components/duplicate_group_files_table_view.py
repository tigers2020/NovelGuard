...
class DuplicateGroupFilesTableView(QWidget):
    ...
    def __init__(
        self, parent: Optional[QWidget] = None, *, file_data_store: "FileDataStore"
    ) -> None:
        """중복 그룹 파일 테이블 뷰 초기화.
    ...
    def _setup_ui(self) -> None:
        ...
        header.setSectionResizeMode(0, QHeaderView.ResizeMode.ResizeToContents)  # Keeper
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 파일명
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.Stretch)  # 경로
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # 범위
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 크기
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 수정일
