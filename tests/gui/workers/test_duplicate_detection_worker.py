...
def test_worker_initialization():
    ...
    worker = DuplicateDetectionWorker(
        request=request, index_repository=index_repository, log_sink=log_sink
    )
...
def test_worker_run_no_index_repository():
    ...
    worker = DuplicateDetectionWorker(request=request, index_repository=None, log_sink=log_sink)
