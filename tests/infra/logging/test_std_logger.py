...
class TestCreateStdLogger:
    ...
    def test_file_logger_creation(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger = create_std_logger(name="test_file", log_file=log_file, level=logging.INFO)
    ...
    def test_custom_format_string(self, caplog):
        ...
        logger = create_std_logger(
            name="test_custom_format", level=logging.INFO, format_string=custom_format
        )
    ...
    def test_log_level_filtering(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger = create_std_logger(
                name="test_level_filter", log_file=log_file, level=logging.WARNING
            )
