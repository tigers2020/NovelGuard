...
class TestIntegrityIssueCreation:
    ...
    def test_create_minimal(self):
        ...
        issue = IntegrityIssue(
            issue_id=1, file_id=10, severity="WARN", category="ENCODING", message="인코딩 문제 발견"
        )
...
class TestIntegrityIssueEquality:
    ...
    def test_equality_by_id(self):
        ...
        issue1 = IntegrityIssue(
            issue_id=1, file_id=10, severity="WARN", category="ENCODING", message="Issue 1"
        )
    ...
    def test_inequality_by_id(self):
        ...
        issue2 = IntegrityIssue(
            issue_id=2, file_id=10, severity="WARN", category="ENCODING", message="Issue 1"
        )
    ...
    def test_hash_by_id(self):
        """ID 기반 해시."""
        issue1 = IntegrityIssue(
            issue_id=1, file_id=10, severity="WARN", category="ENCODING", message="Issue"
        )
        issue2 = IntegrityIssue(
            issue_id=1, file_id=99, severity="ERROR", category="NEWLINE", message="Other"
        )
    ...
    def test_set_membership(self):
        ...
        issue3 = IntegrityIssue(
            issue_id=2, file_id=10, severity="WARN", category="ENCODING", message="Issue 2"
        )
...
class TestIntegrityIssueImmutability:
    ...
    def test_frozen(self):
        ...
        issue = IntegrityIssue(
            issue_id=1, file_id=10, severity="WARN", category="ENCODING", message="..."
        )
...
class TestIntegrityIssueProperties:
    ...
    def test_is_info(self):
        """정보성 이슈 확인."""
        issue = IntegrityIssue(
            issue_id=1, file_id=10, severity="INFO", category="ENCODING", message="..."
        )
    ...
    def test_is_error(self):
        """오류 이슈 확인."""
        issue = IntegrityIssue(
            issue_id=1, file_id=10, severity="ERROR", category="ENCODING", message="..."
        )
    ...
    def test_is_newline_issue(self):
        """줄바꿈 문제 확인."""
        issue = IntegrityIssue(
            issue_id=1, file_id=10, severity="WARN", category="NEWLINE", message="..."
        )
    ...
    def test_is_empty_issue(self):
        """빈 파일 문제 확인."""
        issue = IntegrityIssue(
            issue_id=1, file_id=10, severity="ERROR", category="EMPTY", message="..."
        )
    ...
    def test_is_broken_text_issue(self):
        """깨진 텍스트 문제 확인."""
        issue = IntegrityIssue(
            issue_id=1, file_id=10, severity="ERROR", category="BROKEN_TEXT", message="..."
        )
...
class TestIntegrityIssueMethods:
    ...
    def test_is_more_severe_than(self):
        ...
        warn_issue = IntegrityIssue(
            issue_id=2, file_id=10, severity="WARN", category="NEWLINE", message="..."
        )
        info_issue = IntegrityIssue(
            issue_id=3, file_id=10, severity="INFO", category="ENCODING", message="..."
        )
        ...
        another_error = IntegrityIssue(
            issue_id=4, file_id=10, severity="ERROR", category="EMPTY", message="..."
        )
