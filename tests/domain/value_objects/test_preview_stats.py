...
class TestPreviewStatsCreation:
    ...
    def test_create_minimal(self):
        """최소 정보로 생성."""
        stats = PreviewStats(estimated_total_files=100, top_extensions={".txt": 70, ".md": 30})
    ...
    def test_create_with_bytes(self):
        """크기 추정과 함께 생성."""
        stats = PreviewStats(
            estimated_total_files=100, top_extensions={".txt": 70}, estimated_bytes=1024000
        )
    ...
    def test_create_empty(self):
        """빈 통계 생성."""
        stats = PreviewStats(estimated_total_files=0, top_extensions={})
...
class TestPreviewStatsImmutability:
    ...
    def test_frozen(self):
        ...
        stats = PreviewStats(estimated_total_files=100, top_extensions={".txt": 70})
...
class TestPreviewStatsProperties:
    ...
    def test_extension_count(self):
        """확장자 종류 수."""
        stats = PreviewStats(
            estimated_total_files=100, top_extensions={".txt": 70, ".md": 20, ".pdf": 10}
        )
...
class TestPreviewStatsMethods:
    ...
    def test_get_top_extensions(self):
        ...
        stats = PreviewStats(
            ...
            top_extensions={".txt": 70, ".md": 20, ".pdf": 5, ".jpg": 3, ".png": 2},
        )
...
class TestPreviewStatsUseCases:
    ...
    def test_typical_scan_result(self):
        ...
        stats = PreviewStats(
            ...
            top_extensions={".txt": 1200, ".md": 300, ".pdf": 20, ".docx": 3},
