...
class TestSelectByQualityScore:
    ...
    def test_select_best_quality(self):
        ...
        files = [
            ...
            # 크고, 최신, 높은 신뢰도 → 최고 점수
            create_test_file(2, "file2.txt", size=5000, mtime=3000.0, encoding_confidence=0.95),
            # 중간
            create_test_file(3, "file3.txt", size=3000, mtime=2000.0, encoding_confidence=0.8),
        ]
