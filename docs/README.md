...
Current NovelGuard documentation lives here.
...
Design tokens and UX live at repo root: [DESIGN.md](../DESIGN.md).

Historical material belongs under `documents/` or `docs/archive/`; do not add new specs or plans there.
