...
- [2026-05-22-workflow-pipeline-ui-rev32.md](plans/2026-05-22-workflow-pipeline-ui-rev32.md) — rev. 3.2 wizard shell + one-shot confirm (landed; run-all UI removed in 3.3)
- [2026-05-22-workflow-pipeline-ui-rev33-stabilization.md](plans/2026-05-22-workflow-pipeline-ui-rev33-stabilization.md) — rev. 3.3 stabilization + regression (active)
