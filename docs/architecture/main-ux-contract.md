...
| Bulk auto-approve server job | **Draft** — spec `035-2026-06-05-resolve-bulk-auto-approve-job-design.md` | Policy in spec 033 locked; server job **not implemented** on main |
| Apply preview display rows | **Draft** — spec `036-2026-06-05-apply-preview-display-rows-design.md` | Separate feature PR; WIP on `wip/mixed-035-036-salvage` |
